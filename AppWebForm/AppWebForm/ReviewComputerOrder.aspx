<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewComputerOrder.aspx.cs" Inherits="AppWebForm.ReviewComputerOrder" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="PartNumber" runat="server" Text=""></asp:Label><br />
         <asp:Label ID="Label7" runat="server" Text="Rush Order?: "></asp:Label>
