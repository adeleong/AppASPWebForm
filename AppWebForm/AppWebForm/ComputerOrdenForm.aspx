<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComputerOrdenForm.aspx.cs" Inherits="AppWebForm.ComputerOrdenForm" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="Computer Order" Font-Size="X-Large"></asp:Label>
        <br />
        <br />
        ...
        <br />
        <asp:Label ID="Label5" runat="server" Text="Customer Email: "></asp:Label>
